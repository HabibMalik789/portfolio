...
const allData = [
  ...
  category: ["React"],
  image: process.env.PUBLIC_URL + "/images/portfolio/03.PNG",
  slug: "work-space",
...
},
{
  ...
  category: ["HTML/CSS"],
  image: process.env.PUBLIC_URL + "/images/portfolio/01.png",
  slug: "creative-art",
...
},
{
  ...
  category: ["HTML/CSS"],
  image: process.env.PUBLIC_URL + "/images/portfolio/02.png",
  slug: "apple-usb",
  url: "https://habibmalik789.github.io/e-commerce/",
},
{
  id: 4,
  name: "KC Learn Online Academy",
  category: ["HTML/CSS"],
  image: process.env.PUBLIC_URL + "/images/portfolio/11.PNG",
  slug: "creative-bulb",
  url: "https://habibmalik789.github.io/KC-Learn---Online-Academy-Mianwali/",
},
{
  id: 5,
  name: "Andrews Creation Developed on Wix",
  category: ["WP/Wix"],
  image: process.env.PUBLIC_URL + "/images/portfolio/04.PNG",
  slug: "creative-bulb",
...
},
{
  ...
  category: ["WP/Wix"],
  image: process.env.PUBLIC_URL + "/images/portfolio/05.PNG",
  slug: "creative-bulb",
...
},
{
  ...
  category: ["WP/Wix"],
  image: process.env.PUBLIC_URL + "/images/portfolio/06.PNG",
  slug: "creative-bulb",
...
},
{
  ...
  category: ["WP/Wix"],
  image: process.env.PUBLIC_URL + "/images/portfolio/07.png",
  slug: "creative-bulb",
...
},
{
  ...
  category: ["WP/Wix"],
  image: process.env.PUBLIC_URL + "/images/portfolio/08.PNG",
  slug: "creative-bulb",
...
},
{
  ...
  category: ["WP/Wix"],
  image: process.env.PUBLIC_URL + "/images/portfolio/09.PNG",
  slug: "creative-bulb",
...
},
{
  ...
  category: ["WP/Wix"],
  image: process.env.PUBLIC_URL + "/images/portfolio/10.PNG",
  slug: "creative-bulb",
